        ...
        <div id='projects' className="projects-container">
            <div className="projects">
                ...
                <div className="project">
                    ...
                    <a className="view-site" href="https://lp-expensify-app.herokuapp.com/" target="_blank" rel="noopener noreferrer">View Website</a>
                    <p className="projects-or">|</p>
                    <a href="https://github.com/longphun1/budgetBook-react-app" target="_blank" rel="noopener noreferrer"><img className="github-icon" src="https://i.imgur.com/GdNRuHu.png" alt='1'></img></a>
                </div>
                <div className="project">
